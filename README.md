# Constantino IT Responsive Website
...
This project was created while learning responsive design. The site represents a business landing page with the following sections:
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/ademirconstantino/constantinoit-responsive.git
   cd constantinoit-responsive
